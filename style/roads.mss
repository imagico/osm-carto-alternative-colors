...
@taxiway-tunnel-fill: lighten(@taxiway-fill, 8%);
@taxiway-tunnel-casing: darken(@taxiway-fill, 8%);
...
@access-marking-pedestrian: #d4d4d4;
...
@crossing-marking: #e4e4e4;
@crossing-marking-secondary: #f2f2f2;
@crossing-marking-tertiary: #e2e2e2;
@crossing-marking-living-street: #d4d4d4;
@crossing-marking-pedestrian: #d4d4d4;
@crossing-marking-road: #f0f0f0;

@crossing-casing-width: 0.065;
...
@paths-tunnel-casing-width-z13:   0.75;
  ...
  [road_layer = 'casing'][zoom >= 12] {
    ...
    [feature = 'highway_motorway'] {
      [zoom >= 12] {
        ...
        line-join: round;
        line-cap: round;
        [connect_type = 'flat_end_casing'] { line-cap: butt; }
        [int_tunnel != 'no'] {
          line-dasharray: 4,2;
          line-cap: butt;
        }
        [int_bridge != 'no'] {
          line-cap: butt;
          [connect_type = 'bridge_connect'] { line-cap: round; }
          [zoom >= 13] {
    ...
    [feature = 'highway_steps'] {
      ...
      [int_bridge != 'yes'] {
        [zoom >= 15] {
          ...
          halo/line-cap: butt;
          [connect_type = 'bridge_connect'] { halo/line-cap: round; }
      ...
      [int_tunnel != 'no'] {
        ...
        [zoom >= 15] {
          line-width: [width_max] + 2 * (@paths-background-width + @paths-tunnel-casing-width-z13);
          [zoom >= 15] { line-width: [width_max] + 2 * (@paths-background-width + @paths-tunnel-casing-width); }
    ...
    [feature = 'highway_path'][path_type = 'horse'] {
      ...
      [int_tunnel != 'no'] {
        [zoom >= 13][int_access != 'no'],
        [zoom >= 15] {
          line-width: [width_nominal] + 2 * (@paths-background-width + @paths-tunnel-casing-width-z13);
          [zoom >= 15] { line-width: [width_nominal] + 2 * (@paths-background-width + @paths-tunnel-casing-width); }
          line-color: @tunnel-casing;
          line-dasharray: 4,2;
        }
      }
    ...
    [feature = 'aeroway_taxiway'] {
      [zoom >= 14] {
        ...
        [int_tunnel != 'no'] {
          line-width: [width_max] + 2 * [casing_width];
          line-color: @taxiway-tunnel-casing;
          line-dasharray: 4,2;
          line-join: round;
        }
      }
    ...
    [int_tunnel = 'no'] {
      [zoom >= 18][width >= 4.0][connect_type != 'line_separate'] {
        [feature = 'highway_bridleway'],
        [feature = 'highway_footway'],
        [feature = 'highway_cycleway'],
        [feature = 'highway_path'] {
          ...
          [connect_type = 'flat_end_casing_background'] { tagged/line-cap: butt; }
          [int_bridge != 'no'] {
            tagged/line-color: @bridge-casing;
            tagged/line-cap: butt;
            [connect_type = 'bridge_connect'] { tagged/line-cap: round; }
            [int_bridge = 'ford'],
            [int_bridge = 'ford_node'] {
      ...
      [zoom >= 18][width >= 4.0][connect_type != 'line_separate'] {
        ...
        [feature = 'highway_path'] {
          [int_surface != 'unpaved'] {
            ...
            tagged/line-join: round;
            tagged/line-cap: round;
            [connect_type = 'flat_end_fill_background'] { tagged/line-cap: butt; }
          }
          [int_surface = 'unpaved'] {
            tagged/line-pattern-type: repeat;
            tagged/line-pattern-alignment: global;
            tagged/line-pattern-file: url('symbols/unpaved/unpaved_pedestrian-fill.svg');
            tagged/line-pattern-width: [width] - 2 * [casing_width];
            tagged/line-pattern-cap: round;
            tagged/line-pattern-join: round;
            [connect_type = 'flat_end_fill_background'] { tagged/line-pattern-cap: butt; }
          }
        }
        [feature = 'highway_track'] {
          [int_surface != 'unpaved'] {
          ...
          [int_surface = 'unpaved'] {
            tagged/line-pattern-type: repeat;
            tagged/line-pattern-alignment: global;
            tagged/line-pattern-file: url('symbols/unpaved/unpaved_track-area-fill.svg');
            tagged/line-pattern-width: [width] - 2 * [casing_width];
            tagged/line-pattern-cap: round;
            tagged/line-pattern-join: round;
            [connect_type = 'flat_end_fill_background'] { tagged/line-pattern-cap: butt; }
  ...
  [road_layer = 'fill'] {
      ...
      [feature = 'highway_motorway'] {
        ...
        [zoom >= 12] {
          ...
          [int_tunnel != 'no'] {
            ...
            line-cap: round;
            line-join: round;
            [connect_type = 'flat_end_fill'] { line-cap: butt; }
          }
          [int_tunnel = 'no'][int_surface = 'unpaved'] {
            ...
            line-pattern-width: [width_nominal] - 2 * [casing_width];
            line-pattern-cap: round;
            line-pattern-join: round;
            [connect_type = 'flat_end_fill'] { line-pattern-cap: butt; }
          }
        }
      }
      ...
      [feature = 'highway_service'] {
        ...
        [zoom >= 16][service = 'INT-minor'] {
          ...
          [int_tunnel = 'no'][int_surface = 'unpaved'] {
            line-pattern-type: repeat;
            line-pattern-alignment: global;
            line-pattern-file: url('symbols/unpaved/unpaved_service-fill.svg');
            line-pattern-width: [width_nominal] - 2 * [casing_width];
            line-pattern-cap: round;
            line-pattern-join: round;
            [connect_type = 'flat_end_fill'] { line-pattern-cap: butt; }
      ...
      [zoom >= 12] {
        [int_surface != 'unpaved'] {
          [feature = 'highway_motorway'] {
            ...
            tagged/line-join: round;
            tagged/line-cap: round;
            [connect_type = 'flat_end_fill'] { tagged/line-cap: butt; }
          }
          [feature = 'highway_trunk'] {
        ...
        [int_surface = 'unpaved'] {
          [feature = 'highway_motorway'] {
            tagged/line-pattern-type: repeat;
            tagged/line-pattern-alignment: global;
            tagged/line-pattern-file: url('symbols/unpaved/unpaved_motorway-fill.svg');
            tagged/line-pattern-width: [width_nominal] - 2 * [casing_width];
            tagged/line-pattern-cap: round;
            tagged/line-pattern-join: round;
            [connect_type = 'flat_end_fill'] { tagged/line-pattern-cap: butt; }
          }
          [feature = 'highway_trunk'] {
            tagged/line-pattern-type: repeat;
            tagged/line-pattern-alignment: global;
            tagged/line-pattern-file: url('symbols/unpaved/unpaved_trunk-fill.svg');
            tagged/line-pattern-width: [width_nominal] - 2 * [casing_width];
            tagged/line-pattern-cap: round;
            tagged/line-pattern-join: round;
            [connect_type = 'flat_end_fill'] { tagged/line-pattern-cap: butt; }
          ...
          [feature = 'highway_primary'] {
            tagged/line-pattern-type: repeat;
            tagged/line-pattern-alignment: global;
            tagged/line-pattern-file: url('symbols/unpaved/unpaved_primary-fill.svg');
            tagged/line-pattern-width: [width_nominal] - 2 * [casing_width];
            tagged/line-pattern-cap: round;
            tagged/line-pattern-join: round;
            [connect_type = 'flat_end_fill'] { tagged/line-pattern-cap: butt; }
          ...
          [feature = 'highway_secondary'] {
            tagged/line-pattern-type: repeat;
            tagged/line-pattern-alignment: global;
            tagged/line-pattern-file: url('symbols/unpaved/unpaved_secondary-fill.svg');
            tagged/line-pattern-width: [width_nominal] - 2 * [casing_width];
            tagged/line-pattern-cap: round;
            tagged/line-pattern-join: round;
            [connect_type = 'flat_end_fill'] { tagged/line-pattern-cap: butt; }
          ...
          [feature = 'highway_tertiary'] {
            tagged/line-pattern-type: repeat;
            tagged/line-pattern-alignment: global;
            tagged/line-pattern-file: url('symbols/unpaved/unpaved_tertiary-fill.svg');
            tagged/line-pattern-width: [width_nominal] - 2 * [casing_width];
            tagged/line-pattern-cap: round;
            tagged/line-pattern-join: round;
            [connect_type = 'flat_end_fill'] { tagged/line-pattern-cap: butt; }
          ...
          [feature = 'highway_unclassified'][zoom >= 13] {
            tagged/line-pattern-type: repeat;
            tagged/line-pattern-alignment: global;
            tagged/line-pattern-file: url('symbols/unpaved/unpaved_residential-fill.svg');
            tagged/line-pattern-width: [width_nominal] - 2 * [casing_width];
            tagged/line-pattern-cap: round;
            tagged/line-pattern-join: round;
            [connect_type = 'flat_end_fill'] { tagged/line-pattern-cap: butt; }
          ...
          [feature = 'highway_bus_guideway'][zoom >= 13] {
            tagged/line-pattern-type: repeat;
            tagged/line-pattern-alignment: global;
            tagged/line-pattern-file: url('symbols/unpaved/unpaved_busway-fill.svg');
            tagged/line-pattern-width: [width_nominal] - 2 * [casing_width];
            tagged/line-pattern-cap: round;
            tagged/line-pattern-join: round;
            [connect_type = 'flat_end_fill'] { tagged/line-pattern-cap: butt; }
          ...
          [feature = 'railway_platform'][zoom >= 16] {
            tagged/line-pattern-type: repeat;
            tagged/line-pattern-alignment: global;
            tagged/line-pattern-file: url('symbols/unpaved/unpaved_platform-fill.svg');
            tagged/line-pattern-width: [width_nominal] - 2 * [casing_width];
            tagged/line-pattern-cap: round;
            tagged/line-pattern-join: round;
            [connect_type = 'flat_end_fill'] { tagged/line-pattern-cap: butt; }
          ...
          [feature = 'highway_road'][zoom >= 14] {
            tagged/line-pattern-type: repeat;
            tagged/line-pattern-alignment: global;
            tagged/line-pattern-file: url('symbols/unpaved/unpaved_road-fill.svg');
            tagged/line-pattern-width: [width_nominal] - 2 * [casing_width];
            tagged/line-pattern-cap: round;
            tagged/line-pattern-join: round;
            [connect_type = 'flat_end_fill'] { tagged/line-pattern-cap: butt; }
          ...
          [feature = 'highway_service'][zoom >= 16][service = 'INT-minor'] {
            tagged/line-pattern-type: repeat;
            tagged/line-pattern-alignment: global;
            tagged/line-pattern-file: url('symbols/unpaved/unpaved_service-fill.svg');
            tagged/line-pattern-width: [width_nominal] - 2 * [casing_width];
            tagged/line-pattern-cap: round;
            tagged/line-pattern-join: round;
            [connect_type = 'flat_end_fill'] { tagged/line-pattern-cap: butt; }
    ...
    [feature = 'aeroway_taxiway'] {
      [zoom >= 11] {
        ...
        [zoom >= 14][int_tunnel != 'no'] {
          line-color: @taxiway-tunnel-fill;
          line-width: [width_max];
          line-cap: round;
          line-join: round;
          [connect_type = 'flat_end_fill'] { line-cap: butt; }
...
#roads::noareas {
  ...
  [road_layer = 'tc_fill'][zoom >= 15] {
    ...
    [int_surface = 'unpaved'] {
      line-pattern-width: [width] - 2 * [casing_width];
      line-pattern-type: repeat;
      line-pattern-alignment: global;
      line-pattern-file: url('symbols/unpaved/unpaved_service-fill.svg');
      ...
      [feature = 'highway_track'][zoom >= 15] {
        line-pattern-file: url('symbols/unpaved/unpaved_track-area-fill.svg');
      }
      line-pattern-cap: round;
      line-pattern-join: round;
    }

    [connect_type = 'turning_loop'] {
  ...
  [road_layer = 'fill_bridge'][zoom >= 12],
  [road_layer = 'junction_fill'][zoom >= 14],
  [road_layer = 'area_fill'][zoom >= 14] {

    // road types with no mapped area rendering: only junction polygons and bridge fill
    [road_layer = 'fill_bridge'],
    ...
    [zoom >= 14] {
      ::main,
      ::noareas[road_layer = 'junction_fill'],
      ::noareas[road_layer = 'fill_bridge'],
      ::noareas[int_bridge != 'no'] {
  ...
  [road_layer = 'access'] {
    ...
    [zoom >= 15] {
      ...
      [int_access = 'light'] {
        ...
        [feature = 'highway_pedestrian'] {
          line-color: @access-marking;
          [feature = 'highway_living_street'] { line-color: @access-marking-living-street; }
          [feature = 'highway_pedestrian'] { line-color: @access-marking-pedestrian; }
          line-join: round;
          line-cap: round;
          line-width: 3;
          line-dasharray: 0.1,9;
  ...
  [road_layer = 'crossings'] {
    [zoom >= 15] {
      ...
      [width_max > 9.0] {
        // we keep the background of the center dash with even count to overpaint any lane marking (which would impair readability)
        line-width: (0.175 + @crossing-casing-width)*[width_max];

        bkg1/line-join: round;
        bkg2/line-join: round;
        bkg1/line-cap: round;
        bkg2/line-cap: round;
        bkg1/line-width: (0.175 + @crossing-casing-width)*[width_max];
        bkg1/line-offset: 0.175*[width_max];
        bkg2/line-width: (0.175 + @crossing-casing-width)*[width_max];
        bkg2/line-offset: -0.175*[width_max];
        ...
        [width_max > 9.0] {
          ...
          line-cap: square;
          [int_access = null] { line-width: (0.135 + @crossing-casing-width)*[width_max]; line-cap: round; }

          bkg1/line-width: (0.135 + @crossing-casing-width)*[width_max];
          ...
          [width_max > 18.0] {
            [int_access = null] { line-width: (0.1 + @crossing-casing-width)*[width_max]; }
            bkg1/line-width: (0.1 + @crossing-casing-width)*[width_max];
            bkg1/line-offset: 0.1*[width_max];
            bkg2/line-width: (0.1 + @crossing-casing-width)*[width_max];
            bkg2/line-offset: -0.1*[width_max];

            bkg11/line-join: round;
            bkg22/line-join: round;
            bkg11/line-cap: round;
            bkg22/line-cap: round;
            bkg11/line-width: (0.1 + @crossing-casing-width)*[width_max];
            bkg11/line-offset: 0.3*[width_max];
            bkg22/line-width: (0.1 + @crossing-casing-width)*[width_max];
            bkg22/line-offset: -0.3*[width_max];
            ...
            [width_max > 18.0] {
              ...
              bkg1/line-width: (0.082 + @crossing-casing-width)*[width_max];
              bkg1/line-offset: 0.164*[width_max];
              bkg2/line-width: (0.082 + @crossing-casing-width)*[width_max];
              bkg2/line-offset: -0.16*[width_max];
              bkg11/line-width: (0.082 + @crossing-casing-width)*[width_max];
              ...
              [width_max > 28.0] {
                ...
                [int_access = null] { line-width: (0.07 + @crossing-casing-width)*[width_max]; }
                bkg1/line-width: (0.07 + @crossing-casing-width)*[width_max];
                bkg1/line-offset: 0.07*[width_max];
                bkg2/line-width: (0.07 + @crossing-casing-width)*[width_max];
                bkg2/line-offset: -0.07*[width_max];

                bkg11/line-width: (0.07 + @crossing-casing-width)*[width_max];
                bkg11/line-offset: 0.21*[width_max];
                bkg22/line-width: (0.07 + @crossing-casing-width)*[width_max];
                bkg22/line-offset: -0.21*[width_max];

                bkg111/line-join: round;
                bkg222/line-join: round;
                bkg111/line-cap: round;
                bkg222/line-cap: round;
                bkg111/line-width: (0.07 + @crossing-casing-width)*[width_max];
                bkg111/line-offset: 0.35*[width_max];
                bkg222/line-width: (0.07 + @crossing-casing-width)*[width_max];
                bkg222/line-offset: -0.35*[width_max];
                ...
                marking1/line-offset: 0.07*[width_max];
                marking2/line-width: 0.07*[width_max];
                marking2/line-offset: -0.07*[width_max];

                marking11/line-width: 0.07*[width_max];
                marking11/line-offset: 0.21*[width_max];
                marking22/line-width: 0.07*[width_max];
                marking22/line-offset: -0.21*[width_max];

                marking111/line-join: round;
                marking222/line-join: round;
                marking111/line-width: 0.07*[width_max];
                marking111/line-offset: 0.35*[width_max];
                marking222/line-width: 0.07*[width_max];
                ...
                [width_max > 28.0] {
                  ...
                  marking1/line-offset: 0.124*[width_max];
                  marking2/line-width: 0.062*[width_max];
                  marking2/line-offset: -0.124*[width_max];
                  marking11/line-width: 0.062*[width_max];
                  marking11/line-offset: 0.248*[width_max];
                  marking22/line-width: 0.062*[width_max];
                  marking22/line-offset: -0.248*[width_max];
                  marking111/line-width: 0.062*[width_max];
                  marking111/line-offset: 0.372*[width_max];
                  marking222/line-width: 0.062*[width_max];
                  marking222/line-offset: -0.372*[width_max];
                }
              }
            }
          }
  ...
  [road_layer = 'pipeline_casing'] {
    ...
    [connect_type != null] {
      ...
      caps/line-dasharray: [connect_type];
      caps/line-cap: round;
