...
select
  case
    ...
    when $1 IN ('motorway_link', 'tertiary', 'tertiary_link', 'unclassified', 'residential', 'pedestrian', 'living_street', 'service', 'road', 'runway', 'taxiway', 'sidewalk', 'bridleway', 'footway', 'cycleway', 'path', 'track', 'steps') then
      (case
        when $2 = 12 then 0.1
        when $2 = 13 then 0.5
        when $2 = 14 then 0.5
